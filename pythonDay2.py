...
class details:
    ...
    def rooms_info(self):
        ...
        if ch == 1:
            ...
            print("Window/Split AC.\n")
        elif ch == 3:
            print("\n\t\t3-Bed NON-AC")
            print("\n\t----------------------------------------------------")
            print("Room amenities include: 1 Double Bed + 1 Single Bed,")
            print("Television")
            print("Telephone, a Triple-Door Cupboard, 1 Coffee table")
            print("with 2 sofa, 1")
            print("Side table, Balcony with an Accent")
            print("table with 2 Chair and an")
            ...
            print("Room amenities include: 1 Double Bed + 1 Single Bed,")
            print("Television")
            print("Telephone, a Triple-Door Cupboard, 1 Coffee")
            print("table with 2 sofa, ")
            print("1 Side table, Balcony with an Accent table with 2")
            print("Chair and an")
            print("attached washroom with hot/cold")
            print("water + Window/Split AC.\n\n")
        else:
            print("\n\t invalid entry")
